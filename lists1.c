...
/**
 * _liststr - returns an array of strings of the list->str
 * @head: pointer to first node
 *
 * Return: array of strings
 */
char **_liststr(list_t *head)
{
	list_t *node = head;
...
/**
 * _nodestart - returns node whose string starts with prefix
 ...
 */
list_t *_nodestart(list_t *node, char *prefix, char c)
{
	char *p = NULL;
